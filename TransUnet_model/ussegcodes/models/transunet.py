...
from ussegcodes.models.vit import ViT
...
class Decoder(nn.Module):
    def __init__(self, out_channels, class_num):
        ...
        self.decoder1 = DecoderBottleneck(768, 192)
        self.decoder2 = DecoderBottleneck(320, 96)
        self.decoder3 = DecoderBottleneck(160, 48)
        self.decoder4 = DecoderBottleneck(48, 12)

        self.conv1 = nn.Conv2d(12, class_num, kernel_size=1)
